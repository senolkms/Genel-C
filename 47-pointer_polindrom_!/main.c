...
int main()
{
    ...
    for(p2=cumlem;*p2;p2++); //p2 yi /0 a kadar götürür

    p2--;					// p2 yi son harf yapar

    kontrol=1;
    for(p1=cumlem;kontrol && p1<p2;p1++,p2--) //kontrol 1 olduðu sürece ve ilk elemandan son elemanada gidene kadar çalýþýr
    {
        if(*p1 != *p2)
        {
            kontrol=0;
